...
import { Field } from "@/modules/apartments/editor/Field";
import {
  ApartmentFormState, APT_BOOL_FIELDS, emptyForm, formToPayload, rowToForm,
...
} from "@/modules/apartments/editor/sections";
...
export default function ApartmentEditor() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (isEdit && apartmentId) {
        ...
        setForm(rowToForm(a as Record<string, unknown>));
      }
      setLoading(false);
    })();
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <h1 className="font-display text-3xl">{isEdit ? "Modifier l'appartement" : "Nouvel appartement"}</h1>
